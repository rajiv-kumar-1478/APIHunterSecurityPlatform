...
namespace Platform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260813095829_AddToolArtifactsAndDependencies")]
    partial class AddToolArtifactsAndDependencies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Platform.Domain.Entities.SecurityProviderCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProviderKey", "SecretReference")
                        .IsUnique();

                    b.ToTable("security_provider_credentials", (string)null);
                });
            ...
            modelBuilder.Entity("Platform.Domain.Entities.SecurityScanTool", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("security_scan_tools", (string)null);
                });

            modelBuilder.Entity("Platform.Domain.Entities.SecurityTarget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("security_targets", (string)null);
                });
            ...
            modelBuilder.Entity("Platform.Domain.Entities.ToolDependency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DependencyToolKey")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("ParentToolKey")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<string>("RequiredSha256")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.HasIndex("ParentToolKey", "DependencyToolKey")
                        .IsUnique();

                    b.ToTable("tool_dependencies", (string)null);
                });
