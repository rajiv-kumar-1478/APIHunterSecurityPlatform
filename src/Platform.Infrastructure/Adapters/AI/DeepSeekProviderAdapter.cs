...
public class DeepSeekProviderAdapter : IAiProvider
{
    ...
    public DeepSeekProviderAdapter(HttpClient httpClient, IDataProtectionProvider protectionProvider, AiProviderConfig config)
    {
    ...
    public async Task<AiPromptResponse> CompletePromptAsync(AiPromptRequest request, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            if (!httpResponse.IsSuccessStatusCode)
            {
                ...
                return new AiPromptResponse(
                    ...
                    LatencyMs: stopwatch.ElapsedMilliseconds,
                    ErrorCode: errorCode,
                    ErrorMessage: $"DeepSeek returned status code {(int)httpResponse.StatusCode} ({httpResponse.StatusCode}).",
        ...
        catch (OperationCanceledException) when (ct.IsCancellationRequested)
        {
            ...
            return new AiPromptResponse(
                ...
                LatencyMs: stopwatch.ElapsedMilliseconds,
                ErrorCode: "Timeout",
                ErrorMessage: "DeepSeek request timed out or was cancelled.",
                IsRetryable: true);
        }
        catch (Exception)
        {
